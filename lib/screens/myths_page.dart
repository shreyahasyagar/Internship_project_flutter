...
class MythsScreen extends StatelessWidget {
  ...
  List<Map<String, String>> myths = [
    ...
    {
      "myth": "Garlic can protect against infection from the coronavirus",
    ...
    {
      "myth": "Cats and dogs spreads coronavirus",
      "desc":
          "Currently, there is little evidence to suggest that Covid-19 can infect" +
              " cats and dogs. Scientists are still debating" +
              " the importance of this case to the outbreak.",
      "imgPath": "assets/myths/dogs.png",
    },
    {
      "myth": "It affects only old age people",
    ...
    {
      "myth": "Covid-19 is transmitted through mosquito bites",
                    ...
                    Container(
                      ...
                      child: SmoothPageIndicator(
                        ...
                        effect: WormEffect(
                            ...
                            activeDotColor: Colors.redAccent[400]),
                      ),
                    )
                  ],
                ),
